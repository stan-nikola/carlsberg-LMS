...
export async function getManagerOverview(employeeId, positionId) {
  ...
  // getEmployeeRating/getTeamRating не залежать від subordinateIds (лише
  // від employeeId/positionId, уже відомих на вході) — раніше чекали на
  // окрему третю хвилю Promise.all ПІСЛЯ subordinateIds/summaryMap, хоча
  // могли піти в мережу одразу з першою хвилею. Зайвий послідовний round-
  // trip на кожному завантаженні /manager (виявлено при розслідуванні
  // "холодний старт 4с", 2026-09-20).
