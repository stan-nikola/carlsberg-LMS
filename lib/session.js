...
export const getCurrentUser = cache(async function getCurrentUser() {
  // Cache Components (аудит 2026-09-19): cookies() сам по собі не "санкціонує"
  // подальший Date.now() у verifyCookieValue — той все одно ловиться як
  // blocking-prerender-current-time. connection() — офіційний рецепт Next.js
  // для non-deterministic значень (node_modules/next/dist/docs/…/08-caching.md
