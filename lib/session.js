 ...
 *
 * include: { position: true } — потрібно для isManagerTier() (lib/permissions.js,
 * дивиться на employee.position.level) при гейті /hub ↔ /manager. Безпечне
 * розширення: усі наявні виклики читають лише скалярні поля/role, зв'язок,
 * що додався, їм не заважає.
 */
export async function getCurrentUser() {
  ...
  return prisma.employee.findUnique({ where: { id: employeeId }, include: { position: true } });
}
