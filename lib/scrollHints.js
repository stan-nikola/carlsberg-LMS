...
export function peekScrollTo(target, options = {}) {
  ...
  const shift = peekShift(target ? relative(target) : null, viewportHeight, peekRatio, keepVisible ? relative(keepVisible) : null);
 ...
 */
export function peekShift(rect, viewportHeight, peekRatio = PEEK_RATIO, keepRect = null) {
