 ...
 */
export const PLATFORM_NAME = "CarLS Carlsberg Learning System";
...
// Хмелевий трилисток — окремий бренд-асет (не вирізка з PLATFORM_LOGO_PATH:
// той — растровий PWA-icon із вплавленим написом "Carlsberg", трилисток
// там перекриває літери — вирізати без артефактів неможливо). Той самий
// файл, що вже стоїть декоративним водяним знаком на .profile-card у
// app/styles/hub.css — тут інше застосування: маленький логотип-мітка
// ліворуч від "CarLS" у спільній бренд-мітці (components/PlatformBrand.jsx,
// рендериться в ManagerShell.jsx/HubShell.jsx/app/register/page.js), веб-шлях
// (з provідного "/", не файлова FS-путь, як PLATFORM_LOGO_PATH вище).
export const PLATFORM_HOP_LOGO_PATH = "/assets/brand/hops-leaf-small-green.png";
