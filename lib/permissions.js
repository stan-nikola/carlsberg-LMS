 ...
 * наступний щабель. Потрібно для рекурсивної побудови дерева команди
 * (lib/managerDashboard.js getTeamTree) — кожен вузол дерева підвантажує
 * лише СВОЇХ прямих підлеглих, а не весь список одразу.
 *
