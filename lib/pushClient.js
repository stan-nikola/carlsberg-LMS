...
/**
 * @returns {"unsupported"|"insecure"|"ios-not-installed"|"denied"|"subscribed"|"not-subscribed"}
 */
export async function getPushState() {
  if (typeof window === "undefined") return "unsupported";
  // http по локальній мережі (192.168.x.x:3000) — не secure context: SW і
  // Push API просто відсутні, а iOS-застосунок, доданий з такої адреси,
  // виглядає як standalone і раніше падав у «не підтримує». Окремий стан,
  // щоб людина розуміла, що справа в адресі, а не в пристрої.
