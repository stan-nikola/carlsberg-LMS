 ...
 *
 * Працює з вкладкою "Users" тієї самої Google Таблиці, куди вже пишуться
 * результати тестів (той самий файл, що й RESULTS_WEBHOOK_URL у
 * course-8-steps.html). Колонки на вкладці "Users" (порядок не важливий —
 ...
 *  7. Вставте цю адресу як REG_WEBHOOK_URL у ДВОХ місцях:
 *       - index.html (пошук: "TODO: вставити URL")
 *       - course-8-steps.html (той самий пошук)
